...
public class RedisServiceImpl implements RedisService {
    ...
    @Override
    public long geoAdd(Serializable key, Point point, String member) {
        try {
    ...
    @Override
    public List<Point> geoPos(Serializable key, String member) {
        try {
            List<Point> point =  redisTemplate.opsForGeo().position(key,member);
            return point;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    @Override
    public Distance geoDist(Serializable key, String member1, String member2 ,Metric metric) {
        try {
    ...
    @Override
    public void  geoRadius(Serializable key, Point point, Distance distance) {
        try {
             redisTemplate.opsForGeo().radius(key,point,distance);
        }catch (Exception e){
            e.printStackTrace();
//            return null;
        }
